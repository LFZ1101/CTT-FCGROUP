...
**Data:** 2026-09-10  
**Branch ativa:** `cursor/cct-intelligence-phase6-payroll-310a`  
**Núcleo:** fases 1–7 (integrações = framework sem sync fake)
...
| Fontes + monitoramento + Mediador | DONE_NEEDS_TESTS (CAPTCHA BLOCKED) |
...
- Crawlers por sindicato genéricos (não por template dedicado)
